---
title: '3D scene'
description: 'How script headings automatically generate 3D scenes in the Spark web app'
---

## Auto-generated script outline

When you write a scene heading in a script (for example, `INT. WAREHOUSE - NIGHT`), the Spark web app automatically creates a script outline on the left side, and a corresponding list of 3D scenes on the right. 
...
The 3D scenelist will be empty at first. Each 3D scene is a workspace where you can import assets, set up lighting, and arrange setups and cameras.
