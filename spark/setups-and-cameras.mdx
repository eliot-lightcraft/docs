...
<img src="/images/spark/create-camera-script-panel.png" style={{ borderRadius: '0.5rem' }} alt="Adding a camera from the script panel with a highlighted script line" />
...
<img src="/images/spark/create-camera-dialog.png" style={{ borderRadius: '0.5rem' }} alt="The New Camera dialog with name, preset, lens, objects, and description fields" />
...
<img src="/images/spark/camera-aim-at-dropdown.png" style={{ borderRadius: '0.5rem' }} alt="The Aim At target dropdown in the camera properties panel" />
