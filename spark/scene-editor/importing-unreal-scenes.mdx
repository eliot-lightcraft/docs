...
description: "Export a scene from Unreal Engine as a Gaussian splat and USD file for use in the Spark web app"
---

Export a scene from Unreal Engine as both a Gaussian splat (for the environment) and a USD file (for foreground mesh geometry), then bring them into the Spark web app.
...
## 7. Import into the Spark web app

Bring both the Gaussian splat and the USD foreground elements into the Spark web app.

1. In the Spark web app, click **Add** and choose **Location**.
