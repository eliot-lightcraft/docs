...
<img src="/images/spark/timeline-drag-animation-clip.png" style={{ borderRadius: '0.5rem' }} alt="Adding an animation clip to the timeline from the outliner's Animation row" />
