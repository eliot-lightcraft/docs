...
Locators aren't visible in the Spark iOS app. To bookmark a position you can jump back to on the phone, create a stationary camera from the Setups panel instead — see [iPhone or iPad camera controls](/spark/spark-ios/iphone-camera-controls).
