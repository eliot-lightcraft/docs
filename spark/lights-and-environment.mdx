...
Add lights to your scene from the outliner. The Spark web app supports three light types:
...
Lighting presets and scene lights affect USD assets only. They do not relight Gaussian splats. A splat's baked lighting carries through unchanged in both the Spark web app and the Spark iOS app.
