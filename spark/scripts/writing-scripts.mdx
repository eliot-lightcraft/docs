...
description: 'Create, upload, and edit screenplays in Fountain format within the Spark web app'
---

## Creating a blank script

Open a production and select **New Script** to create a blank screenplay. The Spark web app uses Fountain syntax for screenplay formatting — scene headings, dialogue, action lines, and transitions are all supported.
...
See [script outline and 3D scene list](/spark/scripts/script-outline-and-3d-scene-list) for details on how headings become editable 3D scenes.
