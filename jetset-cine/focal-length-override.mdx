...
The existing [Jetset Cine optical lens calibration system](/tutorials/jetset-cine/lens-calibration) works well up to S35 equivalent focal lengths of about 70-85mm. Beyond that, the visible field of view of the cine lens is too small with respect to the Jetset lens, and the number of optical matches isn’t high enough to make optical lens calibration work well.
