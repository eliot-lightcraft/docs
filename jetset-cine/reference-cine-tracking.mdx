...
This clip is a good reference for the tracking quality that we generally see from a Jetset Cine clip processed without additional tracking refinement, on a camera with an accurate [lens calibration](/tutorials/jetset-cine/lens-calibration). There is enough detail in the practical floor for Jetset to get a decent tracking lock.
